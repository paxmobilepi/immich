...
FROM
  (
    SELECT
      ...
      "SharedLinkEntity__SharedLinkEntity_assets"."trashReason" AS "SharedLinkEntity__SharedLinkEntity_assets_trashReason",
      ...
      "4a35f463ae8c5544ede95c4b6d9ce8c686b6bfe6"."trashReason" AS "4a35f463ae8c5544ede95c4b6d9ce8c686b6bfe6_trashReason",
